...
public class Transaction {
   ...
   public void setInt(Block blk, int offset, int val) {
      ...
      Buffer buff = myBuffers.getBuffer(blk);
      int bkpfileoffset=-1;
      if (buff.isBufferClean())
    	  bkpfileoffset=buff.saveBlock();
   	  int lsn = recoveryMgr.setInt(buff, offset, val, bkpfileoffset);
   ...
   public void setString(Block blk, int offset, String val) {
      ...
      if (buff.isBufferClean())
    	  bkpfileoffset=buff.saveBlock();
      int lsn = recoveryMgr.setString(buff, offset, val, bkpfileoffset);
